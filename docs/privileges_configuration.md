...
| mechele1 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部の非管理職 | なし |
| mechele2 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部の非管理職 | なし |
| mechele3 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部の非管理職 | なし |
| dev | 開発部 | 開発部 | 開発部 | 開発部 |
...
| soft | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | なし | なし | ソフトウェア開発課 without 個人名 |
| prod | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | なし | なし | 製品技術課 without 個人名 |
...
| mechele1 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | なし | なし | 第一設計課 without 個人名     |
| mechele2 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | なし | なし | 第二設計課 without 個人名 |
| mechele3 | システム開発部 + 機電設計部 | システム開発部 + 機電設計部 | なし | なし | 第三設計課 without 個人名 |
...
| develop1 | 開発部 | 開発部 | なし | なし | 開発部 1課 + UTI技術発展処 without 個人名 |
| develop2 | 開発部 | 開発部 | なし | なし | 開発部 2課 + UK S1-Project without 個人名 |
